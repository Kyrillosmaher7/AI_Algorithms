...
class LinearRegressionModel:
    ...
    def fit(self, X: np.ndarray, y: np.ndarray, optimizer: Optimizer, loss_fn: Loss, epochs=1000):
        """
        ...
        for epoch in range(epochs):
            ...
            loss = loss_fn.forward(y, y_pred)  # Scalar value
            ...
            dLoss = loss_fn.backward(y, y_pred)  # Shape: (n_samples,)
            ...
            dLoss_dW = np.dot(X.T, dLoss)  # Shape: (n_features,)
